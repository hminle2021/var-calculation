...
def sumproduct(bid_chg_A, bid_chg_B, weight_A, weight_B, direction_A_text, direction_B_text):
...
def get_daily_var_df(amount_entry, var_historical):
    daily_var_list = []
...
daily_var_95_df = get_daily_var_df(amount_entry, var_95_historical)
daily_var_99_df = get_daily_var_df(amount_entry, var_99_historical)
...
st.write("**VaR 95%**")
st.write(daily_var_95_df.assign(hack='').set_index('hack'))
st.write("**VaR 99%**")
st.write(daily_var_99_df.assign(hack='').set_index('hack'))